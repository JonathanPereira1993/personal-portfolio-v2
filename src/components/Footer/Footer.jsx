...
const Footer = () => {
  ...
  return (
    <div className="relative mt-[100px] border-t py-16 overflow-hidden">
      <BgImage className={"absolute rotate-180 text-center flex justify-center bottom-0 z-0 right-0 left-0"} />
      <div className="max-w-widthScreen mx-auto grid grid-cols-5 z-50">
        <div className="col-span-2 flex flex-col justify-between">
          <div>
            <div className="font-signature text-3xl mb-4 dark:text-colorWhite">J</div>
            <span className="dark:text-[#80808090] z-50 font-light">Thanks for stoping by ッ</span>
          </div>
        ...
        <div>
          <h3 className="mb-8 font-bold text-colorOnyx dark:text-colorWhite">Elsewhere</h3>
          <div className="flex flex-col gap-4 font-light">
            <a
              href="#"
