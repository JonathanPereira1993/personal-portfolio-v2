...
const Button = ({ className, isOutline, children, ...props }) => {
  let cssStyles = isOutline
    ? "bg-white border-[#222222] hover:dark:bg-[#bebebe] rounded-lg color-[#222222] active:bg-[#F7F7F7] hover:bg-[#F7F7F7] active:border-[#000000] active:scale-[0.98] disabled:border-[#DDDDDD] desabled:text-[#DDDDDD] disabled:cursor-not-allowed"
