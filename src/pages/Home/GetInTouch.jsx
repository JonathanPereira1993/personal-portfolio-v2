...
const GetInTouch = () => {
  return (
    <div className="grid grid-cols-2 mx-auto max-w-widthScreen mt-[100px] z-50">
      <div>
        <h1 className="text-5xl dark:text-colorWhite font-semibold mb-4">Let's work together</h1>
      ...
      <div className="flex self-center justify-end">
        <Button className={"bg-[#1A1A1A] cursor-pointer transition-all duration-500 group dark:shadow-darkMode hover:scale-105 bg-gradient-to-t from-black to-[#131313] text-white"}>
